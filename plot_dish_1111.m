function plot_dish_1111(dishDir)
    ...
    for i = 1 : length(pos_file)
        ...
        figure(6); plot(data.time, data.ratio_2); hold on

        % whole cell for all cell in dish
        figure(7); plot(data.time, data.ratio_3); hold on
